...
for q in range(len(moves)):
    moveDict[moves[q][2]] = {'power':int(moves[q][4]),'acc':int(moves[q][7]),'target':'?','category':moves[q][6],'targetBuffs':[0,0,0,0,0],'selfBuffs':[0,0,0,0,0],'statuses':[0,0,0,0,0,0],'type':moves[q][5].capitalize(),'name':moves[q][2], 'priority':int(moves[q][11]), 'flags':moves[q][12]}
    if moves[q][3] == '003':
        ...
        moveDict[moves[q][2]]['selfBuffs'][0] = int(moves[q][9]) + 100
    elif moves[q][3] == '02F':
        moveDict[moves[q][2]]['selfBuffs'][1] = int(moves[q][9]) + 100
    elif moves[q][3] == '030':
        moveDict[moves[q][2]]['selfBuffs'][4] = int(moves[q][9]) + 100
    elif moves[q][3] == '031':
        moveDict[moves[q][2]]['selfBuffs'][4] = int(moves[q][9]) + 100
    elif moves[q][3] == '032':
        moveDict[moves[q][2]]['selfBuffs'][2] = int(moves[q][9]) + 100
    elif moves[q][3] == '033':
        moveDict[moves[q][2]]['selfBuffs'][3] = int(moves[q][9]) + 100
    elif moves[q][3] == '034':
        ...
        moveDict[moves[q][2]]['selfBuffs'][0] = int(moves[q][9]) + 1100
    elif moves[q][3] == '03B':
        ...
        moveDict[moves[q][2]]['targetBuffs'][0] = int(moves[q][9]) + 100
    elif moves[q][3] == '042':
